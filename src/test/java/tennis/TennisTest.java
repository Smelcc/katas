...
public class TennisTest {
	...
	public void doitRetourner_LoveLove_EnDebutDePartie() {
		TennisGame tennisGame = new TennisGame("Mauresmo", "Pierce");
	...
	public void doitRetourner_AdvantagePierce_quand_Mauresmo_marque_4fois_et_Pierce_5fois() {
		...
		tennisGame.score(2);
		String result = tennisGame.getScore();
		Assert.assertEquals("Advantage Pierce", result);
	}
	
	@Test
	public void doitRetourner_GamePierce_quand_Mauresmo_marque_4fois_et_Pierce_6fois() {
		TennisGame tennisGame = new TennisGame("Mauresmo", "Pierce");
		tennisGame.score(2);
		tennisGame.score(2);
		tennisGame.score(2);
		...
		tennisGame.score(2);
		String result = tennisGame.getScore();
		Assert.assertEquals("Game Pierce", result);
	}
	
	@Test
	public void doitRetourner_GameMauresmo_quand_Mauresmo_marque_6fois_et_Pierce_4fois() {
		TennisGame tennisGame = new TennisGame("Mauresmo", "Pierce");
		tennisGame.score(2);
		tennisGame.score(2);
		tennisGame.score(2);
		...
		tennisGame.score(1);
		String result = tennisGame.getScore();
		Assert.assertEquals("Game Mauresmo", result);
	}
